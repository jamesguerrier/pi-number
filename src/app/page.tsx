      ...
      <div className="max-w-6xl mx-auto">
        <Card className="w-full shadow-lg mb-6">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold text-gray-800">Number Analysis App</CardTitle>
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg border shadow-sm">
                  ...
                  {matchingResults[currentInputIndex]?.length > 0 && (
                    <div className="mb-6">
                      <h4 className="font-semibold text-gray-700 mb-2">Found in data:</h4>
                  ...
                  <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Week {currentWeekIndex + 1} of 4</h4>
                    <p className="text-gray-700">{getCurrentQuestion()}</p>
                  </div>
